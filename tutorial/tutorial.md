...
block-beta
  ...
  subgraph Low_Memory_Area ["Low Memory Area (Phys)"]
    direction TB
    BL["Bootloader / BIOS / Stack<br/>0x0000 - 0x8FFF"]:3
    G1["Free Page (Gap)<br/>0x9000 - 0x9FFF"]:1
    
    subgraph Paging_Block ["Paging Structures (No Gaps)"]
      PML4["PML4 Table<br/>0xA000"]:1
      PDPT["PDPT Table<br/>0xB000"]:1
      PDPTK["PDPT_K Table<br/>0xC000"]:1
      PD["PD Table<br/>0xD000"]:1
    eof
    
    G5["SAFETY BUFFER (4 KB)<br/>0xE000"]:1
    
    MMAP["E820 Memory Map<br/>0xF000"]:1
    
    G6["SAFETY BUFFER (4 KB)<br/>0x10000"]:1
    
    BMAP["Kernel Bitmap (Phy)<br/>0x11000"]:1
  eof

  subgraph High_Memory_Area ["Kernel Area (Phys)"]
    VGA["VGA Buffer<br/>0xB8000"]:1
    G7["Free Pool"]:4
    KERN["Kernel Image<br/>0x200000"]:2
  eof

  style BL fill:#f96,stroke:#333
  style Paging_Block fill:#eef,stroke:#333,stroke-dasharray: 5 5
  style PML4 fill:#bbf,stroke:#333
  style PDPT fill:#bbf,stroke:#333
  style PDPTK fill:#bbf,stroke:#333
  style PD fill:#bbf,stroke:#333
  style MMAP fill:#dfd,stroke:#333
  style BMAP fill:#fdd,stroke:#333
  style KERN fill:#f9f,stroke:#333
  style VGA fill:#ffd,stroke:#333



Physical Address  | Structure             | Visualization
==================+=======================+======================================
0x0000 0000       |                       |......................................
    |             |                       |......................................
    |             | Bootloader / BIOS     |......................................
0x0000 8FFF       |                       |......................................
------------------|-----------------------|--------------------------------------
0x0000 9000       | Free Gap (1 Page)     |                                      
------------------|-----------------------|--------------------------------------
0x0000 A000       | PML4                  | .....................................
0x0000 AFFF       | #NO GAP (Edge-to-Edge)| .....................................
------------------|-----------------------|--------------------------------------
0x0000 B000       | PDPT                  | .....................................
0x0000 BFFF       | #NO GAP (Edge-to-Edge)|......................................
------------------|-----------------------|--------------------------------------
0x0000 C000       | PDPT_K                | .....................................
0x0000 CFFF       | #NO GAP (Edge-to-Edge)|......................................
------------------|-----------------------|--------------------------------------
0x0000 D000       | PD                    | .....................................
0x0000 DFFF       |                       |......................................
------------------|-----------------------|--------------------------------------
0x0000 E000       | Free Gap (4 KB)       |
0x0000 EFFF       |                       | 
------------------|-----------------------|--------------------------------------
0x0000 F000       | Memory Map (E820)     | .....................................
------------------|-----------------------|--------------------------------------
0x0001 0000       |                       |                                      
    |             | Free Gap (8KB)        |
    |             |                       |         
